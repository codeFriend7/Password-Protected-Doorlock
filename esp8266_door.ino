...
const char* ssid = "prafull";
const char* password = "mahi@123";
int doorClosed = 1;
...
int get_http(String state)
{
   ...
   // configure ifttt server and url  should be HTTP only..not https!!!  (http://)   
    http.begin("http://maker.ifttt.com/trigger/front_door_opened/with/key/5OoL9bI1gnKuAtU3HlF2onArmXjB5nacATnMUJ4_Y8"); //HTTP
